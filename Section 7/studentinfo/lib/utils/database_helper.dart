...
class DatabaseHelper{
  ...
  final String columnAllergies = "allergies";
  final String columnFathersName = "fathersName";
  final String columnFathersContact = "fathersContact";
  final String columnMothersName = "mothersName";
  final String columnMothersContact = "mothersContact";
  ...
  initDB() async{
    ...
    String path = join(documentDirectory.path, "studentRecordz.db");
  ...
  void _onCreate(Database db, int newVersion) async {
    await db.execute(
        "CREATE TABLE $studentTable($columnId INTEGER PRIMARY KEY, $columnFirstName TEXT, $columnLastName TEXT, "
            "$columnContactNumber TEXT, $columnAddressLine1 TEXT, $columnAddressLine2 TEXT, $columnEmail TEXT, "
            "$columnAllergies TEXT, $columnFathersName TEXT, $columnFathersContact TEXT, $columnMothersName TEXT,"
            "$columnMothersContact)"
    );
  }
